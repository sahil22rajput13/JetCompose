...
class SharedPreference@Inject constructor(@ApplicationContext context: Context) {
    private val sharedPreferences: SharedPreferences =
        context.getSharedPreferences("NeoApp", Context.MODE_PRIVATE)
    ...
    enum class Key {
        ...
        TRADESMENNAME, TOKEN, ISUSERSIGNUP ,ISUSERSIGNIN, FIRSTNAME, LASTNAME, PHONE, POSTCODE,
        USERDETIALS, GENDER, DOB, INJURIES, USERID, USERTYPE, ISLANDINGCOMPLETE,
        ISTRADESMENLANDINGCOMPLETE, DEVICETOKEN, USERNAME,EMAIL, PROFILEIMAGE,
        TOTALCREDIT, ISCARDNOTEMPTY,STOREDVERIFICATIONID,GIVENNAME,FAMILYNAME,DISPLAYNAME
    }
}
